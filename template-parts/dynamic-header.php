...
<header id="site-header" class="site-header dynamic-header <?php echo esc_attr( $header_class ); ?>">
  <div class="top-header-bar">
    <div class="container">
      <div class="top-header-bar-left">
        <?php
          if ( class_exists('Elementor\Plugin') ) {
              echo Plugin::$instance->frontend->get_builder_content_for_display(167);
          }
        ?>
      </div>
      <div>
        <?php
          if ( class_exists('Elementor\Plugin') ) {
              echo Plugin::$instance->frontend->get_builder_content_for_display(173);
          }
        ?>
      </div>
      <div class="top-header-bar-right">
        <?php
          if ( class_exists('Elementor\Plugin') ) {
              echo Plugin::$instance->frontend->get_builder_content_for_display(176);
          }
        ?>
      </div>
    </div>
